...
plt.plot(Ns, errs_actual, "--", c="y", label="Observed empirical error")
plt.plot(Ns, errs_usual, c="xkcd:brick red", label="Usual bound")
plt.plot(Ns, errs_geometric, c="xkcd:navy", label="Transport identity bound")
plt.legend()
plt.xlabel(r"$N$")
...
plt.xlabel("Observed empirical error")
plt.ylabel("Observed empirical error")
plt.grid(alpha=0.3)
if save:
...
plt.loglog(Ns, errs_fixed, label=r"Fixed weights", c="xkcd:brick red")
plt.loglog(Ns, errs_var, label=r"Scheduled weights", c="xkcd:navy")
